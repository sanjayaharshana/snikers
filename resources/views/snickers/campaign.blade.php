...
<body>
    <div class="container" ondblclick="toggleFullscreen()">
        ...
        <div class="step" id="step4">
            ...
            <img src="/uis/05/05_Text_1.png" alt="Snickers Logo" class="snickers-logo" style="width: 38vh;height: auto;margin-bottom: 5vh;cursor: pointer;transition: none;margin-top: 3vh;">

            <div class="loading" id="hungryLoading" style="display: none;">
                <div class="snickers-animation-container" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1000; background: #8B4513; border-radius: 20px; overflow: hidden; display: flex; align-items: center; justify-content: center; animation: gradientShift 4s ease-in-out infinite;">
        ...
        <div class="step" id="step5">
            <div class="snickers-animation-container" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1000; background: #8B4513; border-radius: 20px; overflow: hidden; display: flex; align-items: center; justify-content: center; animation: gradientShift 4s ease-in-out infinite, pulseGlow 3s ease-in-out infinite;">
                <img src="/01/SNICKERS BAR.png" alt="Snickers Bar" class="rotating-snickers" style="width: 200px; height: auto; animation: rotateSnickers 2s linear infinite;">
                <div class="processing-text" style="position: absolute; bottom: 20px; left: 50%; transform: translateX(-50%); color: #FFD700; font-size: 18px; font-weight: bold; text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">
                    Processing your photos...
                </div>
